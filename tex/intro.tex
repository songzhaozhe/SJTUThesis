...
\begin{figure}[!htp]
	...
	{重组网络中的重组操作示意图}
	{Illustration of shuffle operation in ShuffleNet. Figure borrowed from \cite{zhang2017shufflenet}.}
	\label{fig:shuffle}
\end{figure}
\begin{figure}[!htp]
	\centering
	...
	{重组网络的基本结构}
	{Illustration of ShuffleNet blocks. Figure borrowed from \cite{zhang2017shufflenet}.}
