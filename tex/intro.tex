...
\begin{figure}[!htp]
	\centering
	\includegraphics[width=10cm]{ohnm.png}
	\bicaption[Illustration of online hard negative mining used in Fast-RCNN]
	{在Fast-RCNN运用困难负样本学习的示意图}
...
\begin{figure}[!htp]
	\centering
	\includegraphics[width=16cm,height=3cm]{densenet.png}
...
\begin{figure}[!htp]
	\centering
	\includegraphics[width=10cm]{resnext.png}
...
\begin{figure}[!htp]
	\centering
	\includegraphics[width=4cm]{shuffle.png}
	\bicaption[Illustration of shuffle operation in ShuffleNets]
	{重组网络中的重组操作示意图}
...
\begin{figure}[!htp]
	\centering
	\includegraphics[width=4cm]{shufflenet.png}
	\bicaption[Illustration of ShuffleNet blocks]
	{重组网络的基本结构}
