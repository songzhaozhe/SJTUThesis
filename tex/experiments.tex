...
\begin{table}[!hpb]
	\centering
	\bicaption[The per-class accuracy in CIFAR-10 results for ResNet32]
	{ResNet32在CIFAR-10结果中各类别准确率}
...
\begin{table}[!hpb]
	\centering
	\bicaption[The results of Algorithm \ref{algo:baseline} and \ref{algo:fast} on CIFAR-100 under $\lambda=0.1$]
	{算法\ref{algo:baseline}和\ref{algo:fast}在CIFAR-100的结果}
...
\begin{table}[!hpb]
	\centering
	\bicaption[The results of Algorithm \ref{algo:baseline} and \ref{algo:fast} on CIFAR-100 under $\lambda=0.01$]
	{算法\ref{algo:baseline}和\ref{algo:fast}在CIFAR-100的结果}
