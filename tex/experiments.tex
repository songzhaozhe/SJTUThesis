...
We also tested our method on the CIFAR-10 Dataset. The curves are shown in Fig. 

We can see that the curves are very similar to the curves compared to CIFAR-100. This shows the robustness of our method under different datasets.
